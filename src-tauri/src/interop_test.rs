...
fn test_js_to_rust_interop() {
    ...
    let shared_secret =
        hex_to_bytes_32("d88fbfd8e21a80e8765ada5fb5799c404a7d21862f69487ad98f1a8650c64a44");
...
fn test_rust_to_js_interop() {
    ...
    // 加密一条消息（Rust 生成）
    let encrypted = alice
        .encrypt_message("bob", "rust hello".as_bytes())
        .unwrap();
