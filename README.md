...
[![Tests](https://img.shields.io/badge/tests-56%2F56%20passed-brightgreen)]()
...
│   ├── src/
│   │   ├── lib.rs                # App entry + 39 command registrations
...
### Tauri Commands (39 registered, grouped by layer)
